...
CLS_TID2_MEAS = 'cls_tid2_meas'  # Cluster ID for each measurement. The merged localizations for each track TID2 are clustered.
CLS_TID2_ALL = 'cls_tid2_all'   # Cluster ID jointly for all measurements. The merged localizations for each track TID2 are clustered.
